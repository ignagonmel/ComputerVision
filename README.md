...
## Description
The application provides an interactive environment to explore how different local feature descriptors and matching algorithms perform on static images. It processes a sequence of images to perform two main tasks: feature matching between pairs and the construction of a three-image panorama.
## Key Features
